...
Offline tests cover monitoring, socket inventories, identity checks, action handling, widget transitions, public-IP parsing, and mascot interactions. Native Windows operations, DPI rendering, and live public-IP lookup still require validation on the target PC.

</details>

## 🚧 Project status

MEDUSA is actively being developed as an approachable **network visibility and control tool**—useful for quick desktop checks and for learning how a PC communicates.

It is not an antivirus, firewall, or intrusion detection system. Animations and status indicators describe activity and monitoring conditions; they do not classify connections as malicious.

💬 Found a bug or have an idea? Open an issue with the steps to reproduce it, your Windows/Python versions, and a screenshot if useful. Redact addresses or other sensitive details before sharing.
